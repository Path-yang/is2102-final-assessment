...
export default function Step3_2({ onNext }: Step3_2Props) {
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="px-1">
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold mb-1 sm:mb-2">Generate Report</h1>
        <p className="text-sm sm:text-base text-gray-600">Select the type of report you want to generate</p>
      </div>
